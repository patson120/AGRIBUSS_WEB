...
import { NODE_APP_BASE_URL } from "../../../Utils"
					...
					<div className="flex px-8 g300ap-4">
							...
							<div className="flex gap-4 h-[500px]">
								<div className="w-1/6 px-2 flex flex-col gap-2">
									{ product &&
										...
										<img src={`${NODE_APP_BASE_URL}/${item}`} onClick={() => setSelectImage(item)} className={`w-16 bg-gray-100 self-center cursor-pointer rounded-xl shadow-lg h-16 ${selectImage === item ? 'ring-[1px] ring-primary' : ''}`}/>
									))
									}
								</div>
								<div className="w-5/6 bg-gray-100 p-2 px-8 rounded-xl ">
									<img src={`${NODE_APP_BASE_URL}/${selectImage}`} className="w-full  h-full"/>
								</div>
							</div>
							<div>
								<div>
						...
						<div className="w-2/5 px-4 ">
							<div className="flex flex-col gap-1">
								...
								<div className="flex gap-2">
								{product&&	
									// <img src={`${NODE_APP_BASE_URL}/${product.farmer.image[0]}`} className="w-8 self-center cursor-pointer rounded-full shadow-lg h-8"/>
